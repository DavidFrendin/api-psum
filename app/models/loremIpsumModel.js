var data = [
	...
	"Who do you think...",
	"What is it?",
	"I'm afraid I'm not quite sure, sir. He says 'I found her,' and keepsrepeating, 'She's here.'",
...
function getParagraph (firstParagraph = false) {
	var result = (firstParagraph ? 'Star wars ipsum dolor sit amet ' : '');
	var randomLine = getRandomLine();
	result = result + randomLine.charAt(0).toLowerCase() + randomLine.slice(1);
	var targetLength = Math.floor(Math.random() * (12 - 2) + 2) * 100;

	while (result.length < targetLength) {
		result = result + ' ' + getRandomLine();
	}
